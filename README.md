...
At 600 XP the Emperor Dragon becomes one of four traditional Chinese dragon types, or, if it was neglected, a zombie. What decides it is the care it has had over its whole life, counted only while it is out on your screen: time spent put away in the bar is not tracked.

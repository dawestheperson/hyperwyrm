...
PanelWindow {
  ...
  readonly property int cells: Sprites.width(pet.stage)            // frame width in art pixels: 32, or 64 for the long stage-3 forms
  readonly property int spriteW: cells * scale
  readonly property int spriteH: Sprites.height(pet.stage) * scale

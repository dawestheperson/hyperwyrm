...
Panel {
  ...
  Component {
    ...
    Column {
      ...
      Text {
        width: parent.width
        height: Math.ceil(Style.font.bodySmall * 1.4) * 3
        visible: !root.pet.isEgg
        ...
        font.family: root.bar.fontFamily
        font.pixelSize: Style.font.bodySmall
        text: "Favourite snack: " + (root.pet.favSnack !== "" ? Foods.INFO[root.pet.favSnack].label : "still learning")
          + "\nFavourite trick: " + (root.pet.favTrickName !== "" ? root.pet.favTrickName : "still learning")
          + "\nHangs out on " + (root.pet.favSpotName !== "" ? root.pet.favSpotName : "...still learning")
          + (root.pet.usualTime !== "" ? "  \u00b7  visits ~" + root.pet.usualTime : "")
      }
